...
class KGATTrainer(Trainer):
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        ...
        kg_total_loss = super()._train_epoch(
            train_data,
            epoch_idx,
            loss_func=self.model.calculate_kg_h_loss,
            show_progress=show_progress,
        )
        ...
        # train kg_o
        train_data.set_mode(KGDataLoaderState.KG)
        kg_total_loss_o = super()._train_epoch(
            train_data,
            epoch_idx,
            loss_func=self.model.calculate_kg_o_loss,
            show_progress=show_progress,
        )
        ...
        # train kg_e
        train_data.set_mode(KGDataLoaderState.KG)
        kg_total_loss_e = super()._train_epoch(
            train_data,
            epoch_idx,
            loss_func=self.model.calculate_kg_e_loss,
            show_progress=show_progress,
        )
